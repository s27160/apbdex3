...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
        ...
        var result = emps.Select(
            emp => new { EName = emp.EName, Total = emp.Sal + (emp.Comm ?? 0) }
        );
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        // tutaj z powodu złożoności zapytania dla mnie czytelniejszym jest zapis query zamiast method 
        var result = (
            from e in emps
